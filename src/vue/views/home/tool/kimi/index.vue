...
import { useEleHeight, useObserElement } from "@/vue/hooks";
import aiImg from "@/vue/assets/images/ai_img.png";
import userImg from "@/vue/assets/images/user.jpg";
...
const userAvatar = useUserStore().userInfo?.avatar || userImg;
